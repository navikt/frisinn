...
describe('mapSelvstendigNæringsdrivendeFormDataToApiData - førstegangssøknad', () => {
    ...
    describe('invalid data and answers which leads to søkerIkkeSomSelvstendig', () => {
        it('returns undefined if selvstendigHarTaptInntektPgaKorona === NO', () => {
            const apiData = mapSelvstendigNæringsdrivendeFormDataToApiData(
                personligeForetak2019,
                {
                    ...formData,
